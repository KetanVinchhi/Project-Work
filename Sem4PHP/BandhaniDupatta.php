...
<head>
	...
	<title>Bandhani Dupatta -Online Bandhani Store</title>
...
<body>
	...
	<?php
		...
		$sql_query = "select ProductID,ProductSKU,ProductShortDesc,ProductImage from products where ProductCategoryID = 7";
				...
				<div class="main_div">
						...
						echo "<img id='myImg'  src='images/$product_image'  alt='N/A'  />"; ?>
							...
							<div class="image-container">
								...
								<button class="w3-button" id="product" style="font-size:20px; ">BUY NOW
								</button>
						</form>
