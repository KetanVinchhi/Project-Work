...
<head>
	...
	<title>Men's Safa -Online Bandhani Store</title>
...
<body>
	...
	<?php
		...
		$sql_query = "select ProductID,ProductSKU,ProductShortDesc,ProductImage from products where ProductCategoryID = 4";
